...
# 1. Instalar extensiones de PostgreSQL y utilidades del sistema
...
# 6. INSTALACIÓN GRATUITA: Forzar a Composer a instalar las dependencias aquí
...
# 8. Al arrancar, limpia caché, ejecuta migraciones, seeders automáticos y enciende Apache
